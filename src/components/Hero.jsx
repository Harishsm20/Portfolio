...
import { css, git, html, javascript, mongodb, nodejs, reactjs, tailwind, } from '../index';
      ...
      >
        <div className="flex flex-col py-1 px-5 justify-center">
          <motion.h2 variants={textVariant(0.3)} initial="hidden" animate="show"  className={`${styles.heroHeadText} text-[#ffffffaf]`}>
            HI! I'M <span className={`${styles.heroSpanText} text-[#fb442c]`}>HARISH</span>
          </motion.h2>
          ...
          <motion.div variants={zoomIn(0.1, 1)} initial="hidden" animate="show" className="flex gap-5 justify-center">
            ...
            <div className="group relative">
              <button onClick={() => window.open("https://github.com/Harishsm20", "_blank")}>
            ...
            <div className="group relative">
              <button onClick={() => window.open("https://linkedin.com/in/harishsm20", "_blank")}>
